export default {
  ...
  sideBar: {
    ...
    settings: "Réglages",
    profile: "Profil",
    assignDriver: "Attribuer les Bus",
  },
  roles: {
  ...
  assignDriver: {
    firstName: "Prénom",
    lastName: "Nom",
    PlateNo: "Numéro de la plaque",
    Status: "Statut",
    assign: "attribuer",
    unassign: "annuler l`attribution",
    choosePlate: "Choisissez NUmbre de plaque",
    success: "Conducteur affecté au bus avec succès.",
    fail: "Échec d`attribution du bus",
    unauth: "Utilisateur introuvable ou non autorisé",
    successU: "Conducteur non affecté au bus avec succès.",
    failU:
      "Une erreur s`est produite lors de l`annulation de l`attribution du conducteur au bus",
    unauthU: "Utilisateur introuvable ou non autorisé",
  },
};
