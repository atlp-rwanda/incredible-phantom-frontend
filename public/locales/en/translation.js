export default {
  ...
  operator: {
    ...
    19: 'Edit',
    20: 'Delete',
    success: 'Operator sucessful registered!',
    fail: 'register operator failed',
    pending: 'registration pending',
    error: 'There was an error, Check you network and try again',
    deleted: 'Operator succefully deleted',
    registered: 'Operator successfully registered!',
  ...
  drivers: {
    ...
    19: 'Edit',
    20: 'Delete',
    success: 'Driver sucessful registered!',
    fail: 'register driver failed',
    pending: 'registration pending',
    error: 'There was an error, Check you network and try again',
